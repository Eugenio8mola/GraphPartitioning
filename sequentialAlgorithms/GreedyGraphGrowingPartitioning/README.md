...
<div style="text-align: justify;">The GGP algorithm consists of iteratively generating a set E that gathers half the
...
whose first part is E.</div>
<div style="text-align: justify;">If this method is very easy to implement, the quality of the partition obtained
...
multilevel method.</div>
<div style="text-align: justify;">The GGGP algorithm starts with the initialization of the set E. E is initialized as a set that only contains a vertex randomly
...
the total weight of E is equal to half the weight of V.</div>
